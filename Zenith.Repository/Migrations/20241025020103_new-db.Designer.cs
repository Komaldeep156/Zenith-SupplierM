...
namespace Zenith.Repository.Migrations
{
    ...
    [Migration("20241025020103_new-db")]
    partial class newdb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zenith.Repository.DomainModels.DropdownValues", b =>
                {
                    ...
                    b.Property<Guid>("DropdownListsId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Zenith.Repository.DomainModels.DropdownValues", b =>
                {
                    b.HasOne("Zenith.Repository.DomainModels.DropdownLists", "DropdownLists")
                        .WithMany()
                        .HasForeignKey("DropdownListsId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("DropdownLists");
                });

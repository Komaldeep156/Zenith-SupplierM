...
namespace Zenith.Repository.Migrations
{
    ...
    [Migration("20250120051724_createtableSecurityGroupUsers")]
    partial class createtableSecurityGroupUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zenith.Repository.DomainModels.Fields", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Zenith.Repository.DomainModels.SecurityGroupFields", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SecurityGroupFields");
                });

            modelBuilder.Entity("Zenith.Repository.DomainModels.SecurityGroupUsers", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Zenith.Repository.DomainModels.SecurityGroups", b =>
                {
                    ...
                    b.Property<string>("SecurityGroupCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Zenith.Repository.DomainModels.WorkFlows", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Zenith.Repository.DomainModels.SecurityGroupFields", b =>
                {
                    b.HasOne("Zenith.Repository.DomainModels.Fields", "Fields_FieldId")
                        .WithMany()
                        .HasForeignKey("FieldId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Zenith.Repository.DomainModels.SecurityGroups", "SecurityGroup_SecurityGroupId")
                        .WithMany()
                        .HasForeignKey("SecurityGroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Fields_FieldId");

                    b.Navigation("SecurityGroup_SecurityGroupId");
                });
            ...
            modelBuilder.Entity("Zenith.Repository.DomainModels.SecurityGroupUsers", b =>
                {
                    ...
                    b.HasOne("Zenith.Repository.DomainModels.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Zenith.Repository.DomainModels.VendorQualificationWorkFlow", b =>
                {
                    ...
                    b.HasOne("Zenith.Repository.DomainModels.WorkFlows", "WorkFlows")
                        .WithMany()
